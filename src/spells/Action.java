...
public enum Action {
  ...
  TARGET_PLAYER("amount", "who"), CLEAR_PLAYER_TARGET(),
  MANA("operation", "value"), LIVES("operation", "value"),

  //where > w : word, p : targetted players' keyboards
  //how > u : unrevealed, r : revealed, b : blocked, o : owned by target players, n : neutral, O : not owned by targe players
  TARGET_LETTER("amount", "where", "how"), CLEAR_LETTER_TARGET(), LETTER_STATUS("operator", "value"), LETTER_OWNERSHIP("operator", "value"),
